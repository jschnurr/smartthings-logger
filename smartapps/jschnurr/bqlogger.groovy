/**
 * Smartthings http logger
 *
 *  Copyrigth 2022 Jeff Schnurr
 *
...
definition(
    ...
    namespace: 'jschnurr',
    author: 'Jeff Schnurr',
    description: 'Log Smartthings events to http',
    category: 'My Apps',
...
def sendEvent(evt, sensorType) {
    ...
    def params = [
        ...
        headers: ['api_key': "${appSettings.api_key}"],
    ]

    try {
        log.debug "Sending event: ${params}"
        httpPost(params) 
    } catch (e) {
